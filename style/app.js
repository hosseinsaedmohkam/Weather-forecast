...
// //////////////////روز و تاریخ در پیش بینی آینده///////////////////
function getDateString(dateStr) {
  const d = new Date(dateStr);
  return d.toLocaleDateString('en-US', { weekday: 'short', day: 'numeric', month: 'short' });
}
// //////////////////روز و تاریخ در وضعیت فعلی///////////////////////
...
async function checkWeather(cityName) {
  try {
    ...
    //////////////////نمایش تاریخ امروز زیر عکس////////////////////////////////
    todayDateDiv.innerText = getTodayShortDay();

    /////////////////////////بکگراند و صدای زمینه///////////////////////////////
    ...
    switch (weatherMain) {
      ...
      case "Clouds":
        ...
        break;
      case "Clear":
        body.style.backgroundImage = "url('img/1622291-آسمان-و-دریا-در-غروب-آفتاب-ترکیب-طبیعت.jpg')";
